...
class Comment(models.Model):
    ...
    email = models.EmailField(blank=True, verbose_name='ایمیل کاربر')
    ...
    urlhash = models.CharField(max_length=50, unique=True, editable=False, verbose_name='آدرس')
    posted = models.DateTimeField(default=timezone.now, editable=False, verbose_name='تاریخ ثبت')
    ...
    jposted.short_description = "تاریخ ثبت"

    def jedited(self):
        return jalali_converter(self.edited)

    jedited.short_description = "تاریخ ویرایش"
