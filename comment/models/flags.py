...
class Flag(models.Model):
    ...
    state = models.SmallIntegerField(choices=STATES_CHOICES, default=UNFLAGGED, verbose_name='کشور')
...
class FlagInstance(models.Model):
    flag = models.ForeignKey(Flag, on_delete=models.CASCADE, related_name='flags', verbose_name='پرچم')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='flags', verbose_name='کاربر')
